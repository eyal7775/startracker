...
def enablerlcompleter():
    ...
    as completion key and register ~/.python_history as history_data file.
    ...
    def register_readline():
        ...
        if readline.get_current_history_length() == 0:
            # If no history_data was loaded, default to .python_history.
            # The guard is necessary to avoid doubling history_data size at

...
class Console:
    ...
    def input(
        ...
        *,
        ...
        It works in the same way as Python's builtin :func:`input` function and provides elaborate line editing and history_data features if Python's builtin :mod:`readline` module is previously loaded.
